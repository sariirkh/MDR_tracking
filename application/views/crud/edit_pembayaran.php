<title>Edit C_Bayar</title>
<div id="page-wrapper">
   <div class="row col-lg-18">
   
       <div class="panel panel-default">
           <div class="panel-heading"><h3>Setup Cara Pembayran</h3></div>
           <div class="panel-body  ">
               <div class="row col-lg-10">
               <?php foreach($pembayaran as $baris){ ?>
                 <form name="tambah_cbayar" action="<?php echo base_url('bantuan/update_cbayar');?>" method="post" enctype="multipart/form-data">
                       <fieldset>
