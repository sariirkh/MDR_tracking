...
<title>Tambah Profil</title><div id="page-wrapper">
       ...
       <div class="panel panel-default">
           ...
           <div class="panel-body  ">
               <div class="row col-lg-10">
                 <form name="tambah_profil" action="<?php echo base_url('bantuan/input_profil');?>" method="post" enctype="multipart/form-data">
                       <fieldset>
                           <input name="kat_bantuan" type="hidden" value="profil">
                         <div class="card-body "  >
                             <label>Judul</label>
                         ...
                         <div class="btn-group">
                           ...
                           <a class="small" href="<?php echo base_url('bantuan/profil')?>"><button class="btn btn-primary btn-sm btninsert" >Kembali</button></a>
