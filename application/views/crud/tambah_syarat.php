...
<title>Tambah Syarat</title><div id="page-wrapper">
   <div class="row col-lg-18">
       
       <div class="panel panel-default">
           <div class="panel-heading"><h3>Setup Syarat & Ketentuan</h3></div>
           <div class="panel-body  ">
               <div class="row col-lg-10">
                 <form name="tambah_syarat" action="<?php echo base_url('bantuan/input_syarat');?>" method="post" enctype="multipart/form-data">
                       <fieldset>
                           <input name="kat_bantuan" type="hidden" value="syarat">
                         <div class="card-body "  >
                             <label>Judul</label>
